...
import nuxt_plugin_httpserver_796ec546 from 'nuxt_plugin_httpserver_796ec546' // Source: ./http.server.js (mode: 'server')
import nuxt_plugin_http_2b2e47e0 from 'nuxt_plugin_http_2b2e47e0' // Source: ./http.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (process.server && typeof nuxt_plugin_httpserver_796ec546 === 'function') {
    await nuxt_plugin_httpserver_796ec546(app.context, inject)
  }

  if (typeof nuxt_plugin_http_2b2e47e0 === 'function') {
    await nuxt_plugin_http_2b2e47e0(app.context, inject)
  }
